 ...
 */
public class Leaderppp extends javax.swing.JFrame {

    /**
     * Creates new form Leaderppp
     */
    public Leaderppp() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Bilawal Bhutto");

        jLabel3.setFont(new java.awt.Font("Gilroy ExtraBold", 1, 14)); // NOI18N
        jLabel3.setText("Mutaza Wahab");

        jLabel5.setBackground(new java.awt.Color(153, 255, 255));
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/bilawal bhutto (2).jpeg"))); // NOI18N

        jLabel6.setBackground(new java.awt.Color(153, 255, 255));
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/mutaza wahab (2).jpeg"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            pstmt.setString(1, "Murtaza Wahab");
          
             pstmt.setString(1, "Murtaza Wahab");

    int rowsUpdated = pstmt.executeUpdate();
    if (rowsUpdated > 0) {
        JOptionPane.showMessageDialog(null, "Vote for Murtaza Wahab casted successfully");
        conn.close();
        this.dispose();
        new Success().setVisible(true);
    } else {
        JOptionPane.showMessageDialog(null, "No candidate found with the name Murtaza Wahab");
    }
} catch (Exception e) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String sql = "update leaders set vote=vote+1 where candidate=?";
            PreparedStatement pstmt = conn.prepareStatement(sql);
            pstmt.setString(1, "Bilawal Bhutto");
          
             pstmt.setString(1, "Bilawal Bhutto");

    int rowsUpdated = pstmt.executeUpdate();
    if (rowsUpdated > 0) {
        JOptionPane.showMessageDialog(null, "Vote for Bilawal Bhutto casted successfully");
        conn.close();
        this.dispose();
        new Success().setVisible(true);
    } else {
        JOptionPane.showMessageDialog(null, "No candidate found with the name Bilawal Bhutto");
    }
} catch (Exception e) {
    // Handle exceptions appropriately
    JOptionPane.showMessageDialog(null, "Error: " + e.getMessage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Leaderppp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
